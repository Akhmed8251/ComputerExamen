    ...
    return (
        <header className="header">
            <div className="header__container container">
                ...
                <div className='nav'>
                    <Link to='/' className={`nav-link btn${!isTeacherPage() ? ' active' : ''}`}>Студентам</Link>
                    <Link to='/teacher' className={`nav-link btn${isTeacherPage() ? ' active' : ''}`}>Преподавателям</Link>
                </div>
                <div className="action">
                    ...
                    {
                        userName && <div className="action__text">{userName}</div> 
                    }
                </div>
            </div>
        </header>
